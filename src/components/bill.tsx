    ...
    return (
        ...
        <section id="approach" className="relative isolate h-full min-h-0 w-full overflow-hidden [container-type:size]">
            ...
            <div className="relative mx-auto grid h-full min-h-0 max-w-7xl grid-rows-[minmax(0,1fr)_minmax(11rem,38%)] px-5 pt-4 sm:px-8 sm:pt-6 lg:grid-cols-2 lg:grid-rows-1 lg:items-end lg:gap-10 lg:px-20 lg:py-8">
                <div className="relative z-10 flex min-h-0 self-center flex-col items-center overflow-hidden text-center lg:items-start lg:text-left">
                    ...
                    <h1 className="min-h-[3em] text-balance text-[clamp(2rem,6cqh,4rem)] leading-[1.0] font-black [font-family:var(--font-display)] [font-variation-settings:'wght'_700] [-webkit-text-stroke:1px_currentColor] sm:min-h-0 lg:text-[100px]">
                    ...
                    <p className="min-h-[4.05em] max-w-xl text-[clamp(1rem,3cqh,1.5rem)] leading-[1.35] font-light text-blue-400 sm:min-h-0 lg:mx-0">
                        Thoughtful walks, attentive visits, and dependable care shaped around the pet you know best.
                    </p>
                ...
                <div className="relative h-full max-h-full min-h-0 overflow-hidden lg:h-[min(72cqh,40rem)] lg:self-end">
                    <div className="absolute bottom-[10%] size-[60%] rounded-full bg-primary/20 blur-3xl" />
                    <img
                        src={LogoBill}
                        alt="Bill, a fluffy Pomeranian"
                        className="absolute inset-0 z-10 size-full max-h-full max-w-full object-contain object-bottom drop-shadow-2xl"
                    />

...
export function Cabin() {
    return (
        ...
        <section id="approach" className="relative isolate w-full min-h-[calc(100svh-8rem)] overflow-hidden lg:min-h-[calc(100svh-4rem)]">
            ...
            <div className="relative mx-auto grid min-h-[calc(100svh-8rem)] max-w-7xl items-center px-5 pt-10 sm:px-8 lg:min-h-[calc(100svh-4rem)] lg:grid-cols-[1fr_0.9fr] lg:items-end lg:gap-10 lg:py-0">
                <div className="relative z-10 flex self-start flex-col items-center pb-60 text-center sm:pb-72 lg:self-end lg:items-start lg:pb-0 lg:text-left">
                ...
                <div className="absolute inset-x-0 bottom-0 h-52 overflow-hidden sm:h-64 lg:relative lg:inset-auto lg:h-[min(72svh,40rem)] lg:min-h-0 lg:self-end">
                    <div className="absolute bottom-[12%] size-[70%] rounded-full bg-primary/20 blur-3xl" />
                    <img
                        src={LogoBill}
                        alt="A cozy cabin"
                        className="relative z-10 size-full object-cover object-[center_35%] drop-shadow-2xl"
                    />
                    <div className="absolute right-0 bottom-8 z-20 hidden bg-secondary px-5 py-4 text-secondary-content shadow-xl sm:block">
                        <p className="text-xs font-black uppercase tracking-widest">Meet the Cabin</p>
                        <p className="mt-1 text-sm font-medium">Cozy retreat for pets</p>
                    </div>
                </div>
            </div>
        </section>

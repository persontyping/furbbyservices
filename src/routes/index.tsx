    ...
    <>
      <section id="approach" className="relative isolate min-h-[calc(100svh-8rem)] overflow-hidden lg:min-h-[calc(100svh-4rem)]">
        ...
        <div className="relative mx-auto grid min-h-[calc(100svh-8rem)] max-w-7xl items-center px-5 pt-10 sm:px-8 lg:min-h-[calc(100svh-4rem)] lg:grid-cols-[1fr_0.9fr] lg:gap-10 lg:pt-0">
          <div className="relative z-10 self-start pb-52 lg:self-center lg:py-24">
            ...
            <p className="mt-2 max-w-xl leading-7 [font-family:var(--font-dosis)] font-light text text-blue-400 sm:mt-7 sm:text-xl sm:leading-8">
          ...
          <div className="absolute inset-x-0 bottom-0 flex h-52 items-end justify-end overflow-hidden px-4 sm:h-64 sm:px-8 lg:relative lg:inset-auto lg:min-h-[calc(100svh-4rem)] lg:overflow-visible lg:px-0">
